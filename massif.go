/*
Package massif implements a basic (likely incomplete parser) for heap
...
// correspond to the fields in the Massif file "header". Binary is the
...
// Parse parses a Massif file from the given reader, returning the parsed
// representation as a Massif structure, or an error if the input file could
// not be parsed.
